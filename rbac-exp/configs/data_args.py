"""
Data arguments and template configuration for SFT training.
"""
import json
import os
...
class DataArguments:
    ...
    #     default=8,
    #     metadata={"help": "Batch size for prediction/inference."},
    # )
    dataset: Optional[str] = field(
        default="spider_dev_with_role",
        metadata={
            "help": "The name of provided dataset(s) to use. Use commas to separate multiple datasets."
        },
    )
    dataset_dir: Optional[str] = field(
        default="rbac-exp/configs/",
        metadata={"help": "The folder containing dataset_info.json for rbac-exp."},
    )
    ...
    predicted_input_filename: Optional[str] = field(
        default="data/selected/spider/spider_dev_with_role.json",
