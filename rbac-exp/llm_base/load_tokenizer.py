...
from llm_base.adapter import init_adapter
from llm_base.loggings import get_logger, reset_logging
...
def load_model_and_tokenizer(
    ...
    ## Note: New version qwen has fixed this issue. So comment these lines above.
